...
function asAmirror(frase) {
   ...
   // Tu código:
   return frase.split(" ").map(val=>{return val.split("").reverse().join("")}).join(" ")
...
arrayOfStrings.sort(function(elementoUno, elementoDos){return elementoUno.length - elementoDos.length});
